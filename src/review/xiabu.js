...
function Dp(){
    ...
    this.resultFile = "dp.xiabu.txt";
    this.reviewsFile = "dp.xiabu.reviews.txt";
    this.cities = [];
    this.taskQueue = [];
...
Dp.prototype.wgetDetail = function(task,shop){
    ...
    var opt = new helper.basic_options("www.dianping.com",shop.path+"/review_more?pageno="+shop.pageIdx);
...
Dp.prototype.processDetail = function(data,args){
    ...
    $("div.comment-list ul li div.content").each(function(){
    ...
    if(args[1].pageIdx<args[1].pageCount){
	++args[1].pageIdx;
	setTimeout(function(){
