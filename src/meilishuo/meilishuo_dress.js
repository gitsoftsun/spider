...
function Meilishuo() {
    ...
    this.dressFile = "meilishuo.dress.txt";
    this.resultFile = 'meilishuo_dress.txt';
    this.pagePerTask = 75;
}
...
Meilishuo.prototype.wgetList = function(t){
    if(!t){
...
Meilishuo.prototype.processList = function(data,args,res){
    if(!data){
